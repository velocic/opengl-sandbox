...
int main()
{
    ...
    // sprites.back().init(-1.0f, -1.0f, 1.0f, 1.0f, "textures/PNG/CharacterRight_Standing.png");
    // sprites.push_back(Sprite());
    // sprites.back().init(0.0f, -1.0f, 1.0f, 1.0f, "textures/PNG/CharacterRight_Standing.png");
    Sprite sprite1;
    Sprite sprite2;
    sprite1.init(-1.0f, -1.0f, 1.0f, 1.0f, "textures/PNG/CharacterRight_Standing.png");
    sprite2.init(0.0f, -1.0f, 1.0f, 1.0f, "textures/PNG/CharacterRight_Standing.png");
